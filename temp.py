#!/usr/bin/env python
'''
Description: wrapper functions for general text-to-speech using the Amazon Polly API
...
polly = newSession()
pollySpeech(polly, text='Danke', voiceId='Vicki', speak=True, outputFile='{}/danke-vicki'.format(mp3path), outputFormat='wav')
